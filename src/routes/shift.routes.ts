...
router.post("/start", authorizeRoles("CASHIER", "STORE_ADMIN", "SUPER_ADMIN"), ShiftReportController.startShift);
router.patch("/end", authorizeRoles("CASHIER", "STORE_ADMIN", "SUPER_ADMIN"), ShiftReportController.endShift);
router.patch("/:id/end", authorizeRoles("CASHIER", "STORE_ADMIN", "SUPER_ADMIN"), ShiftReportController.endShift);
...
router.get("/branch/:branchId", authorizeRoles("SUPER_ADMIN", "STORE_ADMIN"), ShiftReportController.getBranchShifts);
