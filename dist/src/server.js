...
const checkTcpConnectivity = (host, port, timeoutMs = 5000) => new Promise((resolve, reject) => {
    ...
    const startServer = async () => {
        for (let attempt = 1; attempt <= DB_STARTUP_RETRIES; attempt++) {
            try {
                ...
                console.error(`Database connection failed (attempt ${attempt}/${DB_STARTUP_RETRIES}):`, error);
