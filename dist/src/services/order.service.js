...
export class OrderService {
    static async createOrder(data, cashierId) {
        ...
        if (data.customerId) {
            ...
            if (!customer)
                throw new ResourceNotFoundError("Customer", data.customerId);
        }
    ...
    static async getOrdersByBranch(branchId, limit = 50, filters) {
